 ...
 */
class Shelf_Planner_Connector_BFT_Admin extends Shelf_Planner_Connector_Admin_Public {
	...
	protected function bft_variables_set () {
		...
		/*$this->admin_pages = [
					...
					"install_deinstall_upgrade_database_explanation" => [
						...
						"children" => [
							"install_deinstall_menu" => [
								...
								"file" => "shelf-planner-connector-admin-display-install-deinstall.php",
							...
							"manual_data_manipulation_inside_a_function_explanation" => [
								...
								"children" => [
									"manual_data_manipulation_inside_a_function_example" => [
										...
										"page_title" => "admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_inside_a_function_example()",
							...
							"manual_data_manipulation_listing_by_query_explanation" => [
								...
								"children" => [
									"manual_data_manipulation_listing_by_query_example" => [
										...
										"page_title" => "admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_listing_by_query_example()",
							...
							"manual_data_manipulation_listing_by_array_explanation" => [
								...
								"children" => [
									"manual_data_manipulation_listing_by_array_example" => [
										...
										"page_title" => "admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_listing_by_array_example()",
									...
									"manual_data_manipulation_listing_by_array_example_with_link" => [
										...
										"page_title" => "admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_listing_by_array_example_with_link()",
							...
							"manual_data_manipulation_form_explanation" => [
								...
								"children" => [
									"manual_data_manipulation_form_simple_example" => [
										...
										"children" => [
											"manual_data_manipulation_form_simple_example_teacher" => [
												...
												"page_title" => $this->__("Teacher")." 1 </br> admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_form_example_for_two_pages_set() </br> admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_form_example_for_two_pages_get()",
											...
											"manual_data_manipulation_form_simple_example_student" => [
												...
												"page_title" => $this->__("Student")." 1 </br> admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_form_example_for_two_pages_set() </br> admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_form_example_for_two_pages_get()",
												"function" => "manual_data_manipulation_form_example_for_two_pages_get",
												"file" => "bft-admin-display-form.php",
												"function_load" => "manual_data_manipulation_form_example_for_two_pages_set",
											],
									...
									"manual_data_manipulation_form_group_example" => [
										...
										"page_title" => $this->__("Notes of teacher")." 1  </br> ".$this->__("The teacher ID is hidden")." | ".$this->__("The notes ID are hidden")." </br> admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_form_group_example_set() </br> admin -> class-shelf-planner-connector-admin -> manual_data_manipulation_form_group_example_get()",
			...
			"hello_world" => [
				...
				"page_title" => $this->__("Try to modify admin/partials/shelf-planner-connector-admin-display-hello-world.php"),
	 ...
	 * @return		string
	 */
	public function Shelf_Planner_Connector_bft_get_image() {
	}
	 ...
	 * @return		string
	 */
	public function Shelf_Planner_Connector_bft_get_file() {
	}
