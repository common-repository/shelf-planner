 ...
 */
class Shelf_Planner_Connector_BFT_Display_Table extends Shelf_Planner_Connector_BFT_List_Table{
	/**
	 * Retrieve columns
	 *
	 * @since		1.0.0
	 ...
	 */
	//$this->debug_log_write("Shelf Planner Connector plugin: function_name_or_string");
 ...
 * @access private
 */
class Shelf_Planner_Connector_BFT_List_Table {
