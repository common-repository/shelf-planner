...
<div class="wrap bft_wrap">
	...
	<p><?php echo $this->esc_html_e("Backend Frontend Template provides several functions about countries")?>:</p>
	<ol>
		<li>
			<h3>$this->countries_codes_names_get()</h3>
			<p><?php echo $this->esc_html_e("Returns a country list")?></p>
			<pre>
	$countries_codes_names = [
		...
		<li>
			...
			<p><?php echo $this->esc_html_e("Returns the country name through the country code")?></p>
		</li>
	</ol>
</div>