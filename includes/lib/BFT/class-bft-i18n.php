 ...
 */
class Shelf_Planner_Connector_BFT_i18n {
	...
	public function load_plugin_textdomain() {
		...
		$lang_file_basename = 'shelf-planner-connector';
		...
		if (file_exists($lang_country_file_path_full)) {
			//Language country file shelf-planner-connector-es_ES.mo
		...
		&&	file_exists($lang_file_path_full)) {
			//Language file shelf-planner-connector-es.mo
