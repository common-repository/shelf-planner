 ...
 * @subpackage	Shelf_Planner_Connector/public
...
class Shelf_Planner_Connector_Public extends Shelf_Planner_Connector_BFT_Public {
	...
	**/
	...
	/**
	 * Shelf Planner Connector public variables
	 * 
	 * There are no Shelf Planner Connector public variables
	 */
	...
	public function enqueue_styles_plugin() {
		...
		//Own
		wp_enqueue_style( $this->plugin_id, plugin_dir_url( __FILE__ ) . 'css/shelf-planner-connector-public.css', array(), $this->plugin_version, 'all' );
	}
	...
	public function enqueue_scripts_plugin() {
		...
		// Own
		wp_enqueue_script( $this->plugin_id, plugin_dir_url( __FILE__ ) . 'js/shelf-planner-connector-public.js', array( 'jquery' ), $this->plugin_version, false );
	}
	...
	public function shortcodes_init_plugin() {
		...
		add_shortcode("shelf-planner-connector-shortcode-ajax-test", array($this, "shelf_planner_connector_shortcode_ajax_test"));
		add_shortcode("shelf-planner-connector-shortcode-form-test", array($this, "shelf_planner_connector_shortcode_form_test"));
	}
	...
	/**
	 * The [shelf-planner-connector-shortcode-test] shortcode.
	 * 
	 * Display a Hello World
	 * 
	 * Example: [shelf-planner-connector-shortcode-test additional_text="This is an additional text"]The text inside de tags[/shelf-planner-connector-shortcode-test]
	 *
	 * @since		0.0.1
	 * @version		0.0.1
	...
	/**
	 * The [shelf-planner-connector-shortcode-ajax-test] shortcode.
	 * 
	 * BFT Mini version
	 * 
	 * Preapre the AJAX response
	 * 
	 * Example: [shelf-planner-connector-shortcode-ajax-test]
	 *
	 * @since		0.0.1
	 * @version		0.0.1
	 * @param		array				$atts		Shortcode attributes. Default empty.
	 ...
	 * @return		string				Shortcode	output.
	 */
	public function shelf_planner_connector_shortcode_ajax_test( $atts = [], $content = null, $tag = '' ) {
	}


	/**
	 * The [shelf-planner-connector-shortcode-ajax-test] shortcode AJAX response
	 * 
	 * BFT Mini version
	 * 
	 ...
	 * @return		echo
	 */
	public function shelf_planner_connector_shortcode_ajax_test_response( ) {
	}
	

	/**
	 * The [shelf-planner-connector-shortcode-form-test] shortcode.
	 * 
	 * BFT Mini version
	 * 
	 * Preapre the AJAX response
	 * 
	 * Example: [shelf-planner-connector-shortcode-form-test]
	 *
	 * @since		0.0.1
	 * @version		0.0.1
	 * @param		array				$atts		Shortcode attributes. Default empty.
	 ...
	 * @return		string				Shortcode	output.
	 */
	public function shelf_planner_connector_shortcode_form_test( $atts = [], $content = null, $tag = '' ) {
	}
	 ...
	 * @return		echo
	 */
	public function shelf_planner_connector_shortcode_form_test_response( ) {
	}
