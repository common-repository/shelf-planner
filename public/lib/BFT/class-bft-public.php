 ...
 */
class Shelf_Planner_Connector_BFT_Public extends Shelf_Planner_Connector_Admin_Public {
	...
	public function shelf_planner_connector_shortcode_test( $atts = [], $content = null, $tag = '' ) {
		...
		ob_start();
		require plugin_dir_path( dirname( __FILE__ ) ) . "bft/partials/shelf-planner-connector-shortcode-test.php";
		$html = ob_get_clean(); 
